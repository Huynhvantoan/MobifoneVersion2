package com.toan_itc.mobifone.libs.takephoto.library.uitl;
...
public class TUtils {
     ...
     * @return
     */
    public static ArrayList<Uri> convertImageToUri(Context context,ArrayList<Image>images) throws
        TException {
    ...
    public static void captureBySafely(TContextWrap contextWrap,TIntentWap intentWap)throws TException{
        ...
        if (result.isEmpty()){
            Toast.makeText(contextWrap.getActivity(),contextWrap.getActivity().getResources().getText(
                R.string.tip_no_camera),Toast.LENGTH_SHORT).show();
