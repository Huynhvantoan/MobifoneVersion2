...
public class CTKMTrasauDNFragment extends BaseFragment implements TheloaiView {
  @Inject
  TheloaiPresenter
  mTheloaiPresenter;
  ...
  public static CTKMTrasauDNFragment newInstance() {
    return new CTKMTrasauDNFragment();
  }
